...
Progress: **0 / 4 complete**. Baseline before item 17: `npm run build`,
`npm run campaign`, `npm run survivability`, and `npm run portability` pass;
**1261 tests, 0 failed**.

- [ ] 17 — [NPC docking latch is missing from the snapshot](17-npc-dock-plan-snapshot.md) — missing behavior state · high · small
