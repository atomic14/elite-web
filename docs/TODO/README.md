...
**Work in progress: [90](90-one-home-for-every-constant.md), eleven slices
done, three groups left (the console, the combat trainer, the policy seam),
...
every time it runs. At the last commit that was **266 constants home, 243
