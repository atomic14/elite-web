...
// such path", not "we did not decide": both functions below refuse it, and the
// type system refuses it first.
 ...
 * has to be added here before it can be applied anywhere.
 */
export const IMPACT = {
  /**
